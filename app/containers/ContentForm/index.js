  ...
  toggleItem(item) {
    if (this.state.selected.includes(item)) {
      return this.setState({
        editItem: null,
        selected: this.state.selected.filter(s => s !== item),
      })
    }
    this.setState({
      editItem: item,
